...
from fantasy_engine import VCTFantasyEngine
from predict_match import get_historical_stats, get_latest_roster
...
st.markdown('<div class="dashboard-subtitle">Version 3.0: Best-of-Five (Bo5) Maps, Generative Score Models & Fantasy Engine</div>', unsafe_allow_html=True)
...
if veto_override:
    ...
    for idx in range(maps_count):
        # Choose default based on model or list index
        ...
        # Weight selection: Pick Team A (+1), Pick Team B (-1), Decider (0)
    ...
    # Run the dynamic veto predictor model!
...
with col1:
    ...
    # Progress bars representing probability
    ...
    with tab_maps[idx]:
        ...
        with col_la:
            ...
            for p_name, details in comp_a_map.items():
                ...
                # Render list item with displayicon
                st.markdown(f"""
...
if leaderboard:
    ...
    # Drop map_scores structure for nice table
